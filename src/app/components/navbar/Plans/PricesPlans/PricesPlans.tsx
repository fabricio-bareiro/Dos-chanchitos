...
import { PricesPlansProps } from "./PricePlans.type"
        ...
        <Motiontransition key={id}>
          <div className="p-4 shadow-lg rounded-xl shadow-pink-100" >
            ...
            <div className="my-6 text-center">
              <button className={`px-8 py-3 rounded-xl ${primary ? 'border-2 border-pink-400 text-pink-400 bg-white ' : 'text-white bg-pink-600'}`}>Contratar plan</button>
